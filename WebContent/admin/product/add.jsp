		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><STRONG>Add Products</STRONG></td>
			</tr>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					Market price：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="number" name="market_price" value=""  class="bg" />
				</td>
				
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					Shop price：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="number" name="shop_price" value="" class="bg" />
				</td>
			</tr>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					Describe：</td>
				<td class="ta_01" bgColor="#ffffff">
					<textarea rows="10" cols="40" name="pdesc"></textarea>
				</td>
			</tr>
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit"  value="Submit"
						class="button_ok">Submit</button> <FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
