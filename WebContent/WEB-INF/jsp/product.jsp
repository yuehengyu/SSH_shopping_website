...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>YHY-Shopping website</title>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>Sale price:</dt>
					<dd>
						<strong>CDN$：<s:property value="model.shop_price" /></strong>
						Original price：
						<del>
							CDN$:
				...
				<dl>
					<dt>Promotion:</dt>
					<dd>
						<a target="_blank" title="Flash sale(2018-07-30 ~ 2018-10-01)">Flash
							sale</a>
					</dd>
				</dl>
				<dl>
			...
			<form id="cartForm" action="${pageContext.request.contextPath}/cart_addCart.action" method="post">
				...
				<div class="action">
					...
					<div class="buy">
						<input id="addCart" class="addCart" value="Add to cart"
							type="button" onclick="saveCart()" />
					</div>
				</div>
			</form>
			<div id="bar" class="bar">
				<ul>
					<li id="introductionTab"><a href="#introduction">Introduction
							of product</a></li>
