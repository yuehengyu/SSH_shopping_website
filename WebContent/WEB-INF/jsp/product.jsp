...
<body>
	...
	<div class="container productContent">
		...
		<div class="span18 last">
			...
			<div class="sn">
				<div>Product Number：<s:property value="model.pid"/></div>
			</div>
			<div class="info">
				<dl>
					<dt>Sale price:</dt>
					<dd>
						<strong>CDN$：<s:property value="model.shop_price"/></strong> Original price：
						<del>CDN$:<s:property value="model.market_price"/></del>
					</dd>
				</dl>
				<dl>
					<dt>Promotion:</dt>
					<dd>
						<a target="_blank" title="Flash sale(2018-07-30 ~ 2018-10-01)">Flash sale</a>
					</dd>
				</dl>
				<dl>
					<dt></dt>
